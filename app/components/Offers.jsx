  ...
  const handleAddToCart = (pick, e) => {
    ...
    if (pick.product_id) {
      ...
      addToCart({
        ...
        price: Number(String(pick.price).replace(/[^0-9.]/g, '')), // Fallback, real price would be fetched
      ...
      addToCart({
        ...
        price: Number(String(pick.price).replace(/[^0-9.]/g, '')), // Extract number from string
        image: 'https://placehold.co/400x400/1e1e1e/D5C69E?text=Coffee',
      });
    }
  };
