...
const translations: Translations = {
  ...
  statTodaySales: { ar: 'مبيعات اليوم', tr: 'Bugünkü Satışlar' },
  statWeeklySales: { ar: 'مبيعات الأسبوع', tr: 'Haftalık Satışlar' },
  statMonthlySales: { ar: 'مبيعات الشهر', tr: 'Aylık Satışlar' },
  statTotalRevenue: { ar: 'إجمالي الدخل', tr: 'Toplam Gelir' },
  topProductsTitle: { ar: 'المنتجات الأكثر مبيعاً', tr: 'En Çok Satan Ürünler' },
  salesTrendTitle: { ar: 'مخطط المبيعات والدخل', tr: 'Satış ve Gelir Grafiği' },
  salesCount: { ar: 'عدد المبيعات', tr: 'Satış Adedi' },
  revenueAmount: { ar: 'المبلغ', tr: 'Tutar' },
  last7Days: { ar: 'آخر 7 أيام', tr: 'Son 7 Gün' },
  last30Days: { ar: 'آخر 30 يوم', tr: 'Son 30 Gün' },
  soldQuantity: { ar: 'الكمية المباعة', tr: 'Satılan Adet' },
